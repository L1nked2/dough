...
if __name__ == "__main__":
    ...
    ALREADY_CRAWLED_STATIONS = ["구로디지털단지역", "홍대입구역", "선릉역", "잠실역", "강남역"] + ['가정중앙시장역', '가정중앙시장역', '가정중앙시장역', '가좌역', '가좌역', '가좌역', '가평역', '가평역', '강남역', '강남역', '강남역', '강매역', '강매역', '강매역', '강촌역', '강촌역', '강촌역', '개포동역', '개포동역', '개포동역', '건대입구역', '건대입구역', '건대입구역', '계양역', '계양역', '계양역', '광명사거리역', '광명사거리역', '광명사거리역', '구래역', '구래역', '구래역', '구로디지털단지역', '구로디지털단지역', '구로디지털단지역', '구산역', '구산역', '구산역', '기흥역', '기흥역', '기흥역', '길음역', '길음역', '길음역', '까치산역', '까치산역', '까치산역', '논현역', '대흥역', '대흥역', '대흥역', '덕소역', '덕소역', '덕소역', '덕정역', '덕정역', '덕정역', '도화역', '도화역', '도화역', '독바위역', '독바위역', '독바위역', '동춘역', '동춘역', '동춘역', '둔촌오륜역', '둔촌오륜역', '둔촌오륜역', '마포구청역', '마포구청역', '마포구청역', '마포역', '마포역', '마포역', '명일역', '명일역', '명일역', '모란역', '모란역', '모란역', '발곡역', '발곡역', '발곡역', '백석역', '백석역', '백석역', '백양리역', '백양리역', '백양리역', '부천시청역', '부천시청역', '부천시청역', '사리역', '사리역', '사리역', '산성역', '산성역', '산성역', '삼송역', '삼송역', '삼송역', '상봉역', '상봉역', '상봉역', '상일동역', '상일동역', '상일동역', '서울숲역', '서울숲역', '서울숲역', '서울역역', '서울역역', '서울역역', '석바위시장역', '석바위시장역', '석바위시장역', '선릉역', '선릉역', '선릉역', '성균관대역', '성균관대역', '성균관대역', '성환역', '성환역', '성환역', '소래포구역', '소래포구역', '소래포구역', '솔밭공원역', '솔밭공원역', '솔밭공원역', '송내역', '송내역', '송내역', '송탄역', '송탄역', '송탄역', '숭의역', '숭의역', '숭의역', '시흥능곡역', '시흥능곡역', '시흥능곡역', '시흥대야역', '시흥대야역', '시흥대야역', '신설동역', '신설동역', '신설동역', '신중동역', '신중동역', '신중동역', '신풍역', '신풍역', '야목역', '야목역', '야목역', '약수역', '약수역', '약수역', '양재시민의숲역', '양재시민의숲역', '양재시민의숲역', '양정역', '양정역', '양정역', '연수역', '연수역', '연수역', '영등포구청역', '영등포구청역', '영등포구청역', '영등포역', '영등포역', '영등포역', '예술회관역', '예술회관역', '예술회관역', '원당역', '원당역', '원당역', '월드컵경기장역', '을지로3가역', '잠실역', '장한평역', '전대.에버랜드역', '지석역','퇴계원역', '풍산역', '한대앞역', '한양대역', '홍대입구역', '효창공원앞역', '흥선역'] + ['상록수역', '정발산역', '구의역', '길동역', '시우역', '상갈역', '굽은다리역', '제물포역', '파주역', '양주역', '선정릉역', '성신여대입구역', '한남역', '동인천역', '어천역', '신갈역', '신금호역'] + ['달미역', '온수역', '작전역', '김유정역', '동두천역', '정부과천청사역', '지축역', '지행역', '오산역', '서울대입구역', '탑석역', '서정리역', '돌곶이역', '서현역', '미금역', '안국역', '왕십리역', '고잔역', '개화역', '어룡역', '인청공항2터미 널역', '인천터미널역', '진위역', '송파역', '범골역', '동두천중앙역', '신사역', '남한산성입구역', '강남대역', '둔전역', '사당역', '구반포역', '금촌역', '신현역', '양천향교역', '독정역', '마두역', '버티고개역', '오목천역', '개봉역', '문정역', '김포공항역', '신용산역', '남춘천역', '청명역']
