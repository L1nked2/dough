...
class PlaceDocument:
  def __init__(self, place_data_dict : dict):
    ...
    self.__main_photo_list = place_data_dict['place_main_photo_list']
    self.__provided_photo_list = place_data_dict['place_provided_photo_list']
    self.__food_photo_list = place_data_dict['place_food_photo_list']
    self.__inside_photo_list = place_data_dict['place_inside_photo_list']
  ...
  def into_dict(self) -> dict :
    ...
    place_data_dict['place_main_photo_list'] = self.__main_photo_list
    place_data_dict['place_provided_photo_list'] = self.__provided_photo_list
    place_data_dict['place_food_photo_list'] = self.__food_photo_list
    place_data_dict['place_inside_photo_list'] = self.__inside_photo_list
