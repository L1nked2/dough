...
def parse():
    ...
    parser.add_argument('-g', '--GPU', type=int, default=1, help='Whether GPU to allocate')
    parser.add_argument('-b', '--batch-size', type=int, default=10, help='Batch size <= must be divisor of data_length')
    ...
    parser.add_argument('-t', '--test-size', type=int, default=10, help='Size of test dataset')
    parser.add_argument('-p', '--path', type=str, default='./data', help='train_part module is in utils dir')
    parser.add_argument('-d', '--dropout-rate', type=int, default=0.9998, help='Dropout rate to tune')
