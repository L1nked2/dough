...
def parse():
    ...
    parser.add_argument('-m', '--embedding-dim', type=int, default=16, help='Color embedding dimension')
    parser.add_argument('-o', '--colors', type=int, default=200, help='Selecting color number')
